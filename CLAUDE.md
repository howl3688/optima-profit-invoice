...
- 🔴 **唯一正式站＝ https://optima-profit-invoice.pages.dev/**（Cloudflare Pages，**公司帳號** `39aa57ea828579cf95507a84de97725f`）
...
- `git remote` 是 `github.com/howl3688/optima-profit-invoice`，但 **GitHub Pages 已 404、不是部署管道**（僅版控）。
